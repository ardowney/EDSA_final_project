...
averaged_data$particle_bins <- factor(averaged_data$particle_bins)
...
ggplot(subset(averaged_data_long, sample %in% "CRWD1"), aes(x=particle_bins)) + 
  geom_histogram(stat="identity", aes(x=particle_bins, y=mass_percent))
